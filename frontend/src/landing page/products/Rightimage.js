...
function Rightimage({ productName, productImage, productDescription, link, linkText, playStore, appStore }) {
    return (
        <div className='container'>
            <div className='row mb-5'>
                <div className='col  mt-5 p-5'>
                    ...
                    <a href={link} className='mt-5 fs-5 p-3 mb-5'>{linkText} <i class="fa-solid fa-arrow-right-long"></i> </a>
