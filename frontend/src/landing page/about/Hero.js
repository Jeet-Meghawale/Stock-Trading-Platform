...
function Hero() {
    return (
        <div className='container'>
            ...
            <div className='row mt-5 p-5  fs-6 border-top' style={{lineHeight:""}}>
                <div className='col p-5' style={{fontSize:"1.3em"}}>
                ...
                <div className='col p-5' style={{fontSize:"1.3em"}}>
                    <p>
                        ...
                        <a href='' style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.<br />
